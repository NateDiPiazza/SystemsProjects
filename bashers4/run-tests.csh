...
set resultDir = /u/c/s/cs537-2/tests/p4/results
set scriptDir = /u/c/s/cs537-2/tests/p4/scripts

set weights = ( 10 10 ) #6 6 6 6 6 12.5 12.5 12.5 12.5 10 )
if ($#argv == 1) then
    set list = $argv
else
    set list = "0 1"
